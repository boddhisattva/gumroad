...
class PaypalEventType
  ...
  ORDER_API_EVENTS = [CUSTOMER_DISPUTE_CREATED, CUSTOMER_DISPUTE_RESOLVED, CUSTOMER_DISPUTE_UPDATED,
                      PAYMENT_CAPTURE_COMPLETED, PAYMENT_CAPTURE_DENIED, PAYMENT_CAPTURE_REVERSED,
                      PAYMENT_CAPTURE_REFUNDED].freeze
